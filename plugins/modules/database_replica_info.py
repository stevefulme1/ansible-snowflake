...
DOCUMENTATION = r"""
---
module: database_replica_info
short_description: List Snowflake database replicas
description:
  - Retrieve information about database replicas in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific database replica name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all database replicas
  stevefulme1.snowflake.database_replica_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific database replica
  stevefulme1.snowflake.database_replica_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_database replica
"""

RETURN = r"""
database_replicas:
  description: List of database replica records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    try:
        ...
        sql = "SHOW REPLICATION DATABASES"
    ...
    module.exit_json(changed=False, database_replicas=rows)
