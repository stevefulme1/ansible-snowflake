...
DOCUMENTATION = r"""
---
module: account_parameter_info
short_description: List Snowflake account parameters
description:
  - Retrieve information about account parameters in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific account parameter name or pattern.
    type: str
  limit:
    description:
...
- name: List all account parameters
  stevefulme1.snowflake.account_parameter_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific account parameter
  stevefulme1.snowflake.account_parameter_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_account parameter
"""
...
def run_module():
    ...
    module.exit_json(changed=False, account_parameters=rows)
