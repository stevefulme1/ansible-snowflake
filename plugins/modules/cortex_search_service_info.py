...
DOCUMENTATION = r"""
---
module: cortex_search_service_info
short_description: List Snowflake Cortex Search services
description:
  - Retrieve information about Cortex Search services.
version_added: "1.1.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific service name pattern.
    type: str
  schema_name:
    description: Schema to list services from.
    type: str
  database_name:
    description: Database to list services from.
    type: str
  limit:
    description:
...
- name: List Cortex Search services
  stevefulme1.snowflake.cortex_search_service_info:
    schema_name: PUBLIC
    database_name: AI_DB
    account: myaccount
    user: myuser
...
RETURN = r"""
services:
  description: List of Cortex Search service records.
  type: list
  returned: always
"""
...
def run_module():
    ...
    try:
        ...
        sql = "SHOW CORTEX SEARCH SERVICES"
    ...
    module.exit_json(changed=False, services=rows)
