...
---
module: tag_info
short_description: List Snowflake tags
description:
  - Retrieve tags using SHOW TAGS.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  database:
    description: Database to list tags in.
    type: str
  schema_name:
    description: Schema to list tags in.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all tags
  stevefulme1.snowflake.tag_info:
    account: myaccount
    user: myuser
...
def run_module():
    ...
    module.exit_json(changed=False, tags=rows)
