...
DOCUMENTATION = r"""
---
module: share_grant_info
short_description: List Snowflake share grants
description:
  - Retrieve information about share grants in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific share grant name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all share grants
  stevefulme1.snowflake.share_grant_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific share grant
  stevefulme1.snowflake.share_grant_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
...
RETURN = r"""
share_grants:
  description: List of share grant records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, share_grants=rows)
