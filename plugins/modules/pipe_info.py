...
---
module: pipe_info
short_description: List Snowflake pipes
description:
  - Retrieve information about pipes using SHOW PIPES.
version_added: "1.1.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific pipe name pattern.
    type: str
  schema_name:
    description: Schema to list pipes from.
    type: str
  database_name:
    description: Database to list pipes from.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List pipes
  stevefulme1.snowflake.pipe_info:
    schema_name: PUBLIC
...
RETURN = r"""
pipes:
  description: List of pipe records.
  type: list
  returned: always
"""
...
def run_module():
    ...
    module.exit_json(changed=False, pipes=rows)
