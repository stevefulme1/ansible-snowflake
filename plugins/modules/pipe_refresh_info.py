...
DOCUMENTATION = r"""
---
module: pipe_refresh_info
short_description: List Snowflake pipe refresh history
description:
  - Retrieve information about pipe refresh history in Snowflake.
...
EXAMPLES = r"""
- name: List all pipe refresh history
  stevefulme1.snowflake.pipe_refresh_info:
    account: myaccount
    user: myuser
...
def run_module():
    ...
    module.exit_json(changed=False, pipe_refreshes=rows)
