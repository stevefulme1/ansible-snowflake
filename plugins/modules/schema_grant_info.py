...
DOCUMENTATION = r"""
---
module: schema_grant_info
short_description: List Snowflake schema grants
description:
  - Retrieve information about schema grants in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific schema grant name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all schema grants
  stevefulme1.snowflake.schema_grant_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific schema grant
  stevefulme1.snowflake.schema_grant_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_schema grant
"""

RETURN = r"""
schema_grants:
  description: List of schema grant records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, schema_grants=rows)
