...
DOCUMENTATION = r"""
---
module: snowpark_procedure_info
short_description: List Snowflake Snowpark procedures
description:
  - Retrieve information about Snowpark procedures in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific snowpark procedure name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all Snowpark procedures
  stevefulme1.snowflake.snowpark_procedure_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific snowpark procedure
  stevefulme1.snowflake.snowpark_procedure_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_snowpark procedure
"""

RETURN = r"""
snowpark_procedures:
  description: List of snowpark procedure records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, snowpark_procedures=rows)
