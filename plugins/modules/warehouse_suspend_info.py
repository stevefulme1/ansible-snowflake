...
DOCUMENTATION = r"""
---
module: warehouse_suspend_info
short_description: List Snowflake suspended warehouses
description:
  - Retrieve information about suspended warehouses in Snowflake.
...
EXAMPLES = r"""
- name: List all suspended warehouses
  stevefulme1.snowflake.warehouse_suspend_info:
    account: myaccount
    user: myuser
...
def run_module():
    ...
    module.exit_json(changed=False, suspended_warehouses=rows)
