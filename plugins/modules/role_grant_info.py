...
DOCUMENTATION = r"""
---
module: role_grant_info
short_description: List Snowflake role grants
description:
  - Retrieve information about role grants in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific role grant name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all role grants
  stevefulme1.snowflake.role_grant_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific role grant
  stevefulme1.snowflake.role_grant_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
...
RETURN = r"""
role_grants:
  description: List of role grant records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, role_grants=rows)
