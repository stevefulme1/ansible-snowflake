...
DOCUMENTATION = r"""
---
module: snowpark_function_info
short_description: List Snowflake Snowpark functions
description:
  - Retrieve information about Snowpark functions in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific snowpark function name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all Snowpark functions
  stevefulme1.snowflake.snowpark_function_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific snowpark function
  stevefulme1.snowflake.snowpark_function_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_snowpark function
"""

RETURN = r"""
snowpark_functions:
  description: List of snowpark function records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, snowpark_functions=rows)
