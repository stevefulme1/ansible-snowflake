...
DOCUMENTATION = r"""
---
module: table_clone_info
short_description: List Snowflake table clones
description:
  - Retrieve information about table clones in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific table clone name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all table clones
  stevefulme1.snowflake.table_clone_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific table clone
  stevefulme1.snowflake.table_clone_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
...
RETURN = r"""
table_clones:
  description: List of table clone records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, table_clones=rows)
