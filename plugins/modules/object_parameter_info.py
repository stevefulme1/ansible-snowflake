...
DOCUMENTATION = r"""
---
module: object_parameter_info
short_description: List Snowflake object parameters
description:
  - Retrieve information about object parameters in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific object parameter name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all object parameters
  stevefulme1.snowflake.object_parameter_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific object parameter
  stevefulme1.snowflake.object_parameter_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_object parameter
"""

RETURN = r"""
object_parameters:
  description: List of object parameter records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, object_parameters=rows)
