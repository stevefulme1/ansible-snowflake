...
DOCUMENTATION = r"""
---
module: resource_monitor_info
short_description: List Snowflake resource monitors
description:
  - Retrieve resource monitors using SHOW RESOURCE MONITORS.
version_added: "1.0.0"
...
EXAMPLES = r"""
- name: List resource monitors
  stevefulme1.snowflake.resource_monitor_info:
    account: myaccount
    user: myuser
...
RETURN = r"""
resource_monitors:
  description: List of resource monitor records.
  type: list
  returned: always
"""
...
def run_module():
    ...
    try:
        ...
        rows = client.query("SHOW RESOURCE MONITORS")
