...
---
module: table_info
short_description: List Snowflake tables
description:
  - Retrieve information about tables using SHOW TABLES.
version_added: "1.1.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific table name pattern.
    type: str
  schema_name:
...
- name: List all tables in a schema
  stevefulme1.snowflake.table_info:
    schema_name: PUBLIC
...
def run_module():
    ...
    module.exit_json(changed=False, tables=rows)
