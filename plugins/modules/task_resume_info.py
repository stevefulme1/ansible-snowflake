...
DOCUMENTATION = r"""
---
module: task_resume_info
short_description: List Snowflake resumed tasks
description:
  - Retrieve information about resumed tasks in Snowflake.
...
EXAMPLES = r"""
- name: List all resumed tasks
  stevefulme1.snowflake.task_resume_info:
    account: myaccount
    user: myuser
...
def run_module():
    ...
    module.exit_json(changed=False, resumed_tasks=rows)
