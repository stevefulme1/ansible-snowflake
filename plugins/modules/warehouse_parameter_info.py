...
DOCUMENTATION = r"""
---
module: warehouse_parameter_info
short_description: List Snowflake warehouse parameters
description:
  - Retrieve information about warehouse parameters in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific warehouse parameter name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all warehouse parameters
  stevefulme1.snowflake.warehouse_parameter_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific warehouse parameter
  stevefulme1.snowflake.warehouse_parameter_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_warehouse parameter
"""

RETURN = r"""
warehouse_parameters:
  description: List of warehouse parameter records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    try:
        ...
        sql = "SHOW PARAMETERS IN WAREHOUSE"
    ...
    module.exit_json(changed=False, warehouse_parameters=rows)
