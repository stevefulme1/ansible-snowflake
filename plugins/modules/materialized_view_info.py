...
DOCUMENTATION = r"""
---
module: materialized_view_info
short_description: List Snowflake materialized views
description:
  - Retrieve information about materialized views in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific materialized view name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all materialized views
  stevefulme1.snowflake.materialized_view_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific materialized view
  stevefulme1.snowflake.materialized_view_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_materialized view
"""

RETURN = r"""
materialized_views:
  description: List of materialized view records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, materialized_views=rows)
