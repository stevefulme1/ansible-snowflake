...
DOCUMENTATION = r"""
---
module: warehouse_info
short_description: List Snowflake warehouses
description:
  - Retrieve information about warehouses using SHOW WAREHOUSES.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific warehouse name pattern.
    type: str
  limit:
    description:
...
- name: List all warehouses
  stevefulme1.snowflake.warehouse_info:
    account: myaccount
    user: myuser
...
warehouses:
  description: List of warehouse records.
  type: list
  returned: always
"""
...
def run_module():
    ...
    module.exit_json(changed=False, warehouses=rows)
