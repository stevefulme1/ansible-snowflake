...
DOCUMENTATION = r"""
---
module: database_grant_info
short_description: List Snowflake database grants
description:
  - Retrieve information about database grants in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific database grant name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all database grants
  stevefulme1.snowflake.database_grant_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific database grant
  stevefulme1.snowflake.database_grant_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_database grant
"""

RETURN = r"""
database_grants:
  description: List of database grant records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, database_grants=rows)
