...
---
module: view_info
short_description: List Snowflake views
description:
  - Retrieve information about views using SHOW VIEWS.
version_added: "1.1.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific view name pattern.
    type: str
  schema_name:
    description: Schema to list views from.
    type: str
  database_name:
    description: Database to list views from.
    type: str
...
EXAMPLES = r"""
- name: List views
  stevefulme1.snowflake.view_info:
    schema_name: PUBLIC
...
def run_module():
    ...
    module.exit_json(changed=False, views=rows)
