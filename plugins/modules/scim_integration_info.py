...
DOCUMENTATION = r"""
---
module: scim_integration_info
short_description: List Snowflake SCIM integrations
description:
  - Retrieve information about SCIM integrations in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific scim integration name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all SCIM integrations
  stevefulme1.snowflake.scim_integration_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific scim integration
  stevefulme1.snowflake.scim_integration_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_scim integration
"""

RETURN = r"""
scim_integrations:
  description: List of scim integration records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, scim_integrations=rows)
