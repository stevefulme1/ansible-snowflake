...
DOCUMENTATION = r"""
---
module: table_column_info
short_description: List Snowflake table columns
description:
  - Retrieve information about table columns in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific table column name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all table columns
  stevefulme1.snowflake.table_column_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific table column
  stevefulme1.snowflake.table_column_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_table column
"""

RETURN = r"""
columns:
  description: List of table column records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, columns=rows)
