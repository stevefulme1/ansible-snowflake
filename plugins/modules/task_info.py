...
---
module: task_info
short_description: List Snowflake tasks
description:
  - Retrieve information about tasks using SHOW TASKS.
version_added: "1.1.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific task name pattern.
    type: str
  schema_name:
    description: Schema to list tasks from.
    type: str
  database_name:
    description: Database to list tasks from.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List tasks
  stevefulme1.snowflake.task_info:
    schema_name: PUBLIC
...
def run_module():
    ...
    module.exit_json(changed=False, tasks=rows)
