...
DOCUMENTATION = r"""
---
module: warehouse_resume_info
short_description: List Snowflake resumed warehouses
description:
  - Retrieve information about resumed warehouses in Snowflake.
...
EXAMPLES = r"""
- name: List all resumed warehouses
  stevefulme1.snowflake.warehouse_resume_info:
    account: myaccount
    user: myuser
...
def run_module():
    ...
    module.exit_json(changed=False, resumed_warehouses=rows)
