...
DOCUMENTATION = r"""
---
module: file_format_info
short_description: List Snowflake file formats
description:
  - Retrieve information about file formats in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific file format name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all file formats
  stevefulme1.snowflake.file_format_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific file format
  stevefulme1.snowflake.file_format_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
...
RETURN = r"""
file_formats:
  description: List of file format records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, file_formats=rows)
