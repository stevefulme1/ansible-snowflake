...
DOCUMENTATION = r"""
---
module: data_exchange_info
short_description: List Snowflake data exchanges
description:
  - Retrieve information about data exchanges in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific data exchange name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all data exchanges
  stevefulme1.snowflake.data_exchange_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific data exchange
  stevefulme1.snowflake.data_exchange_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_data exchange
"""

RETURN = r"""
data_exchanges:
  description: List of data exchange records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, data_exchanges=rows)
