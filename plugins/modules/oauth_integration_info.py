...
DOCUMENTATION = r"""
---
module: oauth_integration_info
short_description: List Snowflake OAuth integrations
description:
  - Retrieve information about OAuth integrations in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific oauth integration name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all OAuth integrations
  stevefulme1.snowflake.oauth_integration_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific oauth integration
  stevefulme1.snowflake.oauth_integration_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_oauth integration
"""

RETURN = r"""
oauth_integrations:
  description: List of oauth integration records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, oauth_integrations=rows)
