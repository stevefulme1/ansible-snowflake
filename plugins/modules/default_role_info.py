...
DOCUMENTATION = r"""
---
module: default_role_info
short_description: List Snowflake default roles
description:
  - Retrieve information about default roles in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific default role name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all default roles
  stevefulme1.snowflake.default_role_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific default role
  stevefulme1.snowflake.default_role_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_default role
"""

RETURN = r"""
default_roles:
  description: List of default role records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, default_roles=rows)
