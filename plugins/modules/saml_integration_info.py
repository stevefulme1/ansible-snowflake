...
DOCUMENTATION = r"""
---
module: saml_integration_info
short_description: List Snowflake SAML integrations
description:
  - Retrieve information about SAML integrations in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific saml integration name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all SAML integrations
  stevefulme1.snowflake.saml_integration_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific saml integration
  stevefulme1.snowflake.saml_integration_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_saml integration
"""

RETURN = r"""
saml_integrations:
  description: List of saml integration records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, saml_integrations=rows)
