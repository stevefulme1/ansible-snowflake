...
DOCUMENTATION = r"""
---
module: iceberg_table_info
short_description: List Snowflake Iceberg tables
description:
  - Retrieve information about Iceberg tables in Snowflake.
  - This module is read-only and does not modify any resources.
version_added: "1.0.0"
author: Steve Fulmer (@stevefulme1)
options:
  name:
    description: Filter to a specific iceberg table name or pattern.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all Iceberg tables
  stevefulme1.snowflake.iceberg_table_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"

- name: Get a specific iceberg table
  stevefulme1.snowflake.iceberg_table_info:
    account: myaccount
    user: myuser
    private_key: "{{ private_key }}"
    name: my_iceberg table
"""

RETURN = r"""
iceberg_tables:
  description: List of iceberg table records.
  type: list
  returned: always
  elements: dict
"""
...
def run_module():
    ...
    module.exit_json(changed=False, iceberg_tables=rows)
