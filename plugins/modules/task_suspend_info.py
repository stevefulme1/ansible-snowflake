...
DOCUMENTATION = r"""
---
module: task_suspend_info
short_description: List Snowflake suspended tasks
description:
  - Retrieve information about suspended tasks in Snowflake.
...
EXAMPLES = r"""
- name: List all suspended tasks
  stevefulme1.snowflake.task_suspend_info:
    account: myaccount
    user: myuser
...
def run_module():
    ...
    module.exit_json(changed=False, suspended_tasks=rows)
