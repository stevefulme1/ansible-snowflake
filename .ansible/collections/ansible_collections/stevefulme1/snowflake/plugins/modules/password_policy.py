...
def run_module():
    argument_spec = dict(
        ...
        password_min_length=dict(type="int", default=8),
        password_max_length=dict(type="int", default=256),
        password_min_upper_case_chars=dict(type="int", default=1),
        password_min_lower_case_chars=dict(type="int", default=1),
        password_min_numeric_chars=dict(type="int", default=1),
        password_min_special_chars=dict(type="int", default=0),
        password_max_age_days=dict(type="int", default=90),
        password_max_retries=dict(type="int", default=5),
        password_lockout_time_mins=dict(type="int", default=15),
